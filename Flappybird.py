...
#create a background
background = pygame.transform.scale2x(pygame.image.load('./Image/background-night.png')).convert_alpha() 
floor = pygame.transform.scale2x(pygame.image.load('./Image/floor.png')).convert_alpha()
#create a yellow bird
bird_up = pygame.transform.scale2x(pygame.image.load('./Image/yellowbird-upflap.png').convert_alpha())
bird_down = pygame.transform.scale2x(pygame.image.load('./Image/yellowbird-downflap.png').convert_alpha())
bird_mid = pygame.transform.scale2x(pygame.image.load('./Image/yellowbird-midflap.png').convert_alpha())
...
#create pipe
green_pipe = pygame.image.load('./Image/pipe-green.png').convert()
green_pipe = pygame.transform.scale2x(green_pipe)
pipe_height = [150 , 250, 350 ]
game_over_surface = pygame.transform.scale2x(pygame.image.load('./Image/gameover.png').convert_alpha())
